...
function getPointGen() {
	...
	if (hasUpgrade('v', 13)) gain = gain.mul(upgradeEffect('v', 13))
	if (hasUpgrade('v', 15)) gain = gain.mul(2)
	if (hasUpgrade('t', 42)) gain = gain.mul(2)
	gain = gain.mul(buyableEffect('v', 13))
	return gain
}
//(buyableEffect('v', 13)
